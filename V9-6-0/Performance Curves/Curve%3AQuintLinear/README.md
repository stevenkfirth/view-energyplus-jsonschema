```
{
    "patternProperties": {
        "^.*\\S.*$": {
            ...
            "properties": {
                ...
                "minimum_value_of_v": {
                    "type": "number",
                    "unitsBasedOnField": "input_unit_type_for_v"
                },
                "maximum_value_of_v": {
                    "type": "number",
                    "unitsBasedOnField": "input_unit_type_for_v"
    ...
    "legacy_idd": {
        "field_info": {
            ...
            "coefficient2_v": {
                "field_name": "Coefficient2 v",
                "field_type": "n"
            },
            "coefficient3_w": {
                "field_name": "Coefficient3 w",
                "field_type": "n"
            },
            "coefficient4_x": {
                "field_name": "Coefficient4 x",
                "field_type": "n"
            },
            "coefficient5_y": {
            ...
            "coefficient6_z": {
                "field_name": "Coefficient6 z",
                "field_type": "n"
            },
            "minimum_value_of_v": {
                "field_name": "Minimum Value of v",
                "field_type": "n"
            },
            "maximum_value_of_v": {
                "field_name": "Maximum Value of v",
                "field_type": "n"
            },
            "minimum_value_of_w": {
            ...
            "input_unit_type_for_v": {
                "field_name": "Input Unit Type for v",
                "field_type": "a"
            },
            "input_unit_type_for_w": {
