```
{
        ...
        "^.*\\S.*$": {
            ...
            "properties": {
                ...
                "cooling_coil_object_type": {
                    ...
                    "note": "Only works with DX cooling coil types"
                },
                "cooling_coil_name": {
                    "type": "string",
                    "data_type": "object_list",
    ...
    "legacy_idd": {
        "field_info": {
            ...
            "furnace_air_inlet_node_name": {
                "field_name": "Furnace Air Inlet Node Name",
                "field_type": "a"
            },
            "furnace_air_outlet_node_name": {
                "field_name": "Furnace Air Outlet Node Name",
                "field_type": "a"
            },
            "supply_air_fan_operating_mode_schedule_name": {
    ...
    "type": "object",
    "memo": "Unitary system, heating and cooling with constant volume supply fan (continuous or cycling), direct expansion (DX) cooling coil, heating coil (gas, electric, hot water, or steam), and optional reheat coil for dehumidification control. Identical to AirLoopHVAC:UnitaryHeatCool.",
    "min_fields": 17.0
}
```
