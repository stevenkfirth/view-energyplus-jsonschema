        ...
        "^.*\\S.*$": {
            ...
            "properties": {
                ...
                "low_fan_speed_air_flow_rate": {
                    "units": "m3/s",
                    "note": "Low speed air flow rate must be less than high speed air flow rate Low speed air flow rate must be greater than free convection air flow rate",
                    "anyOf": [
                        {
                            "type": "number",
                            "exclusiveMinimum": 0.0
                ...
                "low_fan_speed_u_factor_times_area_value": {
                    "units": "W/K",
                    "note": "Leave field blank if tower Performance Input Method is NominalCapacity Low speed tower UA must be less than high speed tower UA Low speed tower UA must be greater than free convection tower UA",
                    "anyOf": [
                        {
                            "type": "number",
                            "exclusiveMinimum": 0.0,
