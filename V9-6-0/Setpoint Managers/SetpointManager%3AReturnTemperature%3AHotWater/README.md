        ...
        "^.*\\S.*$": {
            ...
            "properties": {
                ...
                "return_temperature_setpoint_constant_value": {
                    "type": "number",
                    "note": "This is the desired return temperature target, which is met by adjusting the supply temperature setpoint. This constant value is only used if the Design Hot Water Return Temperature Input Type is Constant",
                    "units": "C",
                    "default": 71.0
                },
                "return_temperature_setpoint_schedule_name": {
                    "type": "string",
                    "note": "This is the desired return temperature target, which is met by adjusting the supply temperature setpoint. This is a schedule name to allow the return temperature target value to be scheduled. This field is only used if the Design Hot Water Return Temperature Input Type is Scheduled",
